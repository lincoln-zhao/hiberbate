...
<html>
  ...
  <link rel="stylesheet" href="css/adminlogin.css" type="text/css"></link>
    <style>
  ...
  <script type="text/javascript">
  	function userLogin () {
		...
		$.ajax({
			type:'post',
			data:{adminName:adminName,password:password,type:"adminLogin"},
...
<tr>
    ...
    <td width="371"> <input name="username" id="adminName" type="text" style="height:30px; width:300px;"></td>
  </tr>
  <tr>
    ...
    <td> <input name="password" id="password" type="text" style="height:30px; width:300px;">
	  <div class="a14">
	    <a href="javascript:void(0)" onclick="userLogin()"><input  type="submit"  style="height:40px; width:100px;" name="login" value="登录" /></a></div>  </td></tr>
</table>
</div>
<p>&nbsp;</p>
